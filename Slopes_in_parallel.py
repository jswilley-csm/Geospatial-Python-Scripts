...
textfile = open('short_list.txt','r')
...
Projection = [Projection for i in range(len(urls))]
Geotransform = [Geotransform for i in range(len(urls))]
Height = [Height for i in range(len(urls))]
Width = [Width for i in range(len(urls))]
Extent = [Extent for i in range(len(urls))]
Resolution = [Resolution for i in range(len(urls))]



def mosaic_slope(url,Projection,Geotransform,Height,Width,Extent,Resolution):
...
with concurrent.futures.ProcessPoolExecutor() as executor:
	executor.map(mosaic_slope,urls,Projection,Geotransform,Height,Width,Extent,Resolution)
